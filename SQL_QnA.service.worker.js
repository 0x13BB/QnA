...
const CACHE_NAME = "SQL_QnA-cache";
const OFFLINE_URL = "SQL_QnA.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["SQL_QnA.html","SQL_QnA.js","SQL_QnA.wasm","SQL_QnA.pck","SQL_QnA.offline.html","SQL_QnA.icon.png","SQL_QnA.apple-touch-icon.png"];
